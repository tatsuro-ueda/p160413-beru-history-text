...
(function($) {
    ...
    var dic = {
        ...
        {
            type: '歴史',
            content: imgSmall('20160328/20080401153911.jpg', 'l',
                '1547年時点でのハプスブルク家の領土')
        ...
        {
            type:'歴史',
            content: imgSmall('20160328/20120816105356.jpg', 'l',
                '自由主義・国民主権の前は<button>絶対王政</button>だった（エリザベス1世）')
            + '諸侯や貴族・教会の権力が地方に乱立していた状態から、強大な権力を持って中央集権化を図り、中央官僚と常備軍（<button>近衛隊</button>）によって国家統一を成し遂げた体制のこと'
        },
        'ブルボン家':
        {
            type: '歴史',
            content: imgSmall('20160328/20160401134146.jpg', 'p',
                '「太陽王」ルイ14世の肖像画')
            + '近世フランス王家。</p>'
        ...
        'パレ・ロワイヤル':
        {
            ...
            + imgSmall('20160401/20160401141640.png', 'l',
            ...
            + imgSmall('20160401/20160401140223.png', 'l',
        ...
        {
            type:'時代',
            content:imgSmall('20160330/20160330174858.jpg', 'p',
                '連隊はそれぞれ独自の旗を持って戦った')
        ...
        {
            type:'時代',
            content:imgSmall('20160330/20160330175018.jpg', 'l',
                '「誤るのが人間である」（古代ローマ）')
        ...
        {
            type:'時代',
            content:imgSmall('20160330/20160330175142.jpg', 'l',
                'スイスの駅馬車')
        ...
        {
            type:'台詞',
            content:imgSmall('20160330/20160330175357.png', 'l',
        ...
        {
            type:'人物',
            content:imgSmall('20160330/20160330175853.jpg', 'p',
                'カミーユ・デムーランの肖像')
